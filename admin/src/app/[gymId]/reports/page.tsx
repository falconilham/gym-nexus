...
export default function ReportsPage() {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <Box>
                <Typography variant="h4" sx={{ color: 'white', fontWeight: 'bold' }}>Reports & Analytics</Typography>
                <Typography variant="body2" sx={{ color: '#9CA3AF', mt: 1 }}>Insights into your gym's performance.</Typography>
            </Box>
            
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '2fr 1fr' }, gap: 3 }}>
                
                {/* Peak Hours Chart */}
                <Paper sx={{ p: 3, backgroundColor: '#1E1E1E', border: '1px solid #333', borderRadius: 3 }}>
                    <Typography variant="h6" sx={{ color: 'white', mb: 4, fontWeight: 'bold' }}>Peak Hours (Last 7 Days)</Typography>
